...
const STEP_TYPES = ['agent', 'condition', 'loop', 'parallel', 'stop', 'tool', 'http', 'transform', 'filter', 'switch', 'variable', 'data', 'humanReview', 'output', 'join', 'ai', 'subflow'] as const satisfies readonly StepType[]
